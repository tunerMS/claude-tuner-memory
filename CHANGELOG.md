...
- **Обзор «зачем это и что даёт».** [docs/OVERVIEW.md](docs/OVERVIEW.md) — проблема, пять эффектов, устройство в двух словах, принципы и готовый ответ одним абзацем.
- **Справочник команд.** [docs/COMMANDS.md](docs/COMMANDS.md) — все команды сетапа в одном месте: `mem` CLI, слэш-команды инстинктов (`/instinct-status`, `/evolve`, экспорт/импорт) с нюансом их совместимости с этим сетапом, служебные скрипты и стоп-краны.
